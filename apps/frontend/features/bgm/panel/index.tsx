...
export const Panel = ({ roomId, onClose }: Panel) => {
  ...
  return (
    <div className="flex max-h-[calc(100dvh-7rem)] w-[360px] max-w-[calc(100vw-48px)] flex-col gap-5 overflow-hidden rounded-md border border-rule bg-paper/95 p-4 shadow-[0_16px_36px_-22px_oklch(from_var(--ink)_l_c_h/0.3)]">
