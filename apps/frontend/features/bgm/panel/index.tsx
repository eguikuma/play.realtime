...
export const Panel = ({ roomId, onClose }: Panel) => {
  ...
  return (
    <div className="flex max-h-[calc(100svh-9rem)] w-[min(360px,calc(100vw-2rem))] flex-col gap-5 overflow-hidden rounded-md border border-rule bg-paper/95 p-4 shadow-[0_16px_36px_-22px_oklch(from_var(--ink)_l_c_h/0.3)]">
