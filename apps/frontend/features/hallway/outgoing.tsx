...
export const Outgoing = ({ toName, onCancel }: Outgoing) => (
  <div
    role="status"
    className="pointer-events-auto flex max-w-[calc(100vw-3rem)] animate-slip-in items-center gap-3 rounded-pill border border-rule bg-paper-2/95 py-2 pr-2 pl-4 shadow-[0_16px_32px_-20px_oklch(from_var(--ink)_l_c_h/0.24)] backdrop-blur-md"
  >
